...
<section id="Caratula">
    <div style="margin: 1px 1px; width: 80%;">
        <table>
            <tr>
                <th colspan="5">CARÁTULAS DE EXPEDIENTE DE REGISTRO QUE SE INGRESA A LA BASE DE DATOS DE LA COMISIÓN
                    ESTATAL DE BUSQUEDA DE VERACRUZ
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td rowspan="2">{{ $desaparecido->persona->edadAnhos() }} </td>
            ...
            <tr>
                ...
                <th rowspan="2">LOCALIZADO C/V
                    <table>
                        <th><br></th>
                    </table>
                </th>
                <th rowspan="2">LOCALIZADO S/V
                    <table>
                        <th><br></th>
                    </table>
                </th>
