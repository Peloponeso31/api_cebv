...
<div class="parrafo">
    ...
    <mark style="background-color: #FEF2CD; font-size: 25px">18:51 horas del día 14 de enero del 2024,</mark>
    el (la) suscrita
...
<div id="content">
    ...
    <p>
        ...
        <mark style="background-color: #FEF2CD;">{{-- $reportante->persona->telefonos->first()->numero ?? 'Sin numero' --}}</mark>
        , perteneciente
    ...
    <p>
        ...
        <mark style="background-color: #FEF2CD;">19:02
            horas
        </mark>
