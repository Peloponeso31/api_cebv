...
<body>
    ...
    <div class="Estatura-Peso">
        <p><b>Estaura:</b><p>{{ $desaparecido->persona->estatura }}m</p> </p>
        <p><b>Peso:</b><p>{{ $desaparecido->persona->peso }}kg</p> </p>
    </div> 
    </section>
