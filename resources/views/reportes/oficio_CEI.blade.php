...
<body>
    ...
    <p class="texto2">
        <table>
            ...
            <tr>
                <td><mark style="background-color: #FEF2CD;">{{ $desaparecido->persona->nombre }} {{ $desaparecido->persona->apellido_paterno }} {{ $desaparecido->persona->apellido_materno }}</mark></td>
                <td><mark style="background-color: #FEF2CD;">{{ $desaparecido->persona->curp }}</mark></td>
                <td>
                    <ul>
    ...
    <p class="texto3">Se anexa a la presente: <b><mark style="background-color: #FEF2CD;">ficha de media filiación</mark> elaborada por la Comisión Estatal de Búsqueda, el cual contiene los datos generales y fotografía de las personas desaparecidas y/o no localizadas.</b> <br>
